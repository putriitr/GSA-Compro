                    ...
                    <div class="card-body p-0">
                        <table class="table table-borderless mb-0">
                            ...
                            <tbody>
                                    ...
                                    @else bg-secondary @endif">
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('distribution.tickets.show', $ticket->id_after_sales) }}"
                                                class="btn btn-info btn-sm"><i class="fas fa-eye"></i> {{ __('messages.view') }}</a>
                                            @if ($ticket->status == 'open')
                                                <a href="{{ route('distribution.tickets.edit', $ticket->id_after_sales) }}"
                                                    class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> {{ __('messages.edit') }}</a>
                                                <form
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"><i
                                                            class="fas fa-times-circle"></i> {{ __('messages.hapus') }}</button>
                                                </form>
                                            @endif
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center text-muted">{{ __('messages.no_ticket') }}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
