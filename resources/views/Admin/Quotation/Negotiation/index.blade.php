                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <button class="btn btn-success btn-sm rounded-pill shadow-sm"
                                                onclick="openModal({{ $negotiation->id }}, 'accept')">
                                                <i class="fas fa-check"></i> Accept
                                            </button>
                                            <button class="btn btn-danger btn-sm rounded-pill shadow-sm"
                                                onclick="openModal({{ $negotiation->id }}, 'reject')">
                ...
                <form id="notesForm" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="notesModalLabel"
                            style="font-family: 'Poppins', sans-serif; color: #00796b;">Add Notes</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="notes" style="font-weight: bold;">Notes</label>
                            <textarea class="form-control rounded shadow-sm" id="notes" name="notes" rows="4"
                                placeholder="Provide additional notes here..." required></textarea>
                        </div>
                    </div>
