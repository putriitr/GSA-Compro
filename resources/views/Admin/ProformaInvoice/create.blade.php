    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('admin.proforma-invoices.store', $purchaseOrder->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('pi_date') is-invalid @enderror" id="pi_date"
                    name="pi_date" required>
                @error('pi_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('vendor_address') is-invalid @enderror" id="vendor_address" name="vendor_address"
                    rows="2" readonly>{{ old('vendor_address', $user->alamat) }}</textarea>
            ...
            <div id="product-list">
                @foreach ($products as $index => $product)
                    <div class="row mb-3">
                        <div class="col-md-1">
                            <label>No</label>
                            <input type="number" class="form-control" name="products[{{ $index }}][no]"
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="subtotal" name="subtotal" value="{{ $subtotal }}"
                    readonly>
            </div>

            <div class="mb-3">
                <label for="ppn" class="form-label">PPN (%)</label>
                <input type="number" class="form-control" id="ppn" name="ppn" value="{{ $ppn }}"
                    readonly>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('dp') is-invalid @enderror" id="dp"
